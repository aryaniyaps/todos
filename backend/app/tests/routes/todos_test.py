...
def test_read_todos(app: Sanic) -> None:
    ...
    """
    response = app.test_client.get(app.url_for("app.todos.read_todos"))
...
def test_clear_todos(app: Sanic) -> None:
    ...
    """
    response = app.test_client.delete(app.url_for("app.todos.clear_todos"))
...
def test_create_todo(app: Sanic) -> None:
    ...
    response = app.test_client.post(app.url_for("app.todos.create_todo"), json=data)
...
def test_read_todo(app: Sanic, todo: Todo) -> None:
    ...
    """
    response = app.test_client.get(app.url_for("app.todos.read_todo", todo_id=todo.id))
    assert response.status_code == HTTPStatus.OK
...
def test_read_foreign_todo(app: Sanic, foreign_todo: Todo) -> None:
    ...
    """
    response = app.test_client.get(app.url_for("app.todos.read_todo", todo_id=foreign_todo.id))
...
def test_update_todo(app: Sanic, todo: Todo) -> None:
    ...
    response = app.test_client.patch(app.url_for("app.todos.update_todo", todo_id=todo.id), json=data)
    assert response.status_code == HTTPStatus.OK
...
def test_update_foreign_todo(app: Sanic, foreign_todo: Todo) -> None:
    ...
    """
    data = {"content": "sample content", "completed": True}
    response = app.test_client.patch(app.url_for("app.todos.update_todo", todo_id=foreign_todo.id), json=data)
    assert response.status_code == HTTPStatus.NOT_FOUND
...
def test_delete_todo(app: Sanic, todo: Todo) -> None:
    ...
    """
    response = app.test_client.delete(app.url_for("app.todos.delete_todo", todo_id=todo.id))
    assert response.status_code == HTTPStatus.NO_CONTENT
...
def test_delete_foreign_todo(app: Sanic, foreign_todo: Todo) -> None:
    ...
    """
    response = app.test_client.delete(app.url_for("app.todos.delete_todo", todo_id=foreign_todo.id))
    assert response.status_code == HTTPStatus.NOT_FOUND